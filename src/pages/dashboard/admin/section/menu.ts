...
export default class AdminMenuDashboard {
  static element: HTMLElement = document.createElement('div');
  static htmlTemplateurl =
    '/assets/templates/pages/customer-dashboard/section/admin-menu.html';
  ...
  static createAccordionHeader(heading: string) {
    ...
    const deleteMenuItem = document.createElement('i');
    deleteMenuItem.className = 'fa-solid fa-check accordion-header-action-icon';
    deleteMenuItem.id = 'delete-menu-item';
    accordionHeader.appendChild(deleteMenuItem);
    ...
    iconWrapper.appendChild(deleteMenuItem);
